...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        materiasModulos[1A Lunes 1] = MateriaHorario(id=2, fechacreacion=datetime.date.today(), materia=materias[CP], modulo=modulos['1'], dia=cronogramasDias[1A Lunes])
materiasModulos[1A Martes 1] = MateriaHorario(id=3, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1A Martes])
materiasModulos[1A Miercoles 1] = MateriaHorario(id=4, fechacreacion=datetime.date.today(), materia=materias[TL], modulo=modulos['1'], dia=cronogramasDias[1A Miercoles])
materiasModulos[1A Jueves 1] = MateriaHorario(id=5, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1A Jueves])
materiasModulos[1A Viernes 1] = MateriaHorario(id=6, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[1A Viernes])
materiasModulos[1B Lunes 1] = MateriaHorario(id=7, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1B Lunes])
materiasModulos[1B Martes 1] = MateriaHorario(id=8, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1B Martes])
materiasModulos[1B Miercoles 1] = MateriaHorario(id=9, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1B Miercoles])
materiasModulos[1B Jueves 1] = MateriaHorario(id=10, fechacreacion=datetime.date.today(), materia=materias[CP], modulo=modulos['1'], dia=cronogramasDias[1B Jueves])
materiasModulos[1B Viernes 1] = MateriaHorario(id=11, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[1B Viernes])
materiasModulos[1C Lunes 1] = MateriaHorario(id=12, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1C Lunes])
materiasModulos[1C Martes 1] = MateriaHorario(id=13, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[1C Martes])
materiasModulos[1C Miercoles 1] = MateriaHorario(id=14, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1C Miercoles])
materiasModulos[1C Jueves 1] = MateriaHorario(id=15, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[1C Jueves])
materiasModulos[1C Viernes 1] = MateriaHorario(id=16, fechacreacion=datetime.date.today(), materia=materias[CP], modulo=modulos['1'], dia=cronogramasDias[1C Viernes])
materiasModulos[2A Lunes 1] = MateriaHorario(id=17, fechacreacion=datetime.date.today(), materia=materias[CP], modulo=modulos['1'], dia=cronogramasDias[2A Lunes])
materiasModulos[2A Martes 1] = MateriaHorario(id=18, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[2A Martes])
materiasModulos[2A Miercoles 1] = MateriaHorario(id=19, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2A Miercoles])
materiasModulos[2A Jueves 1] = MateriaHorario(id=20, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[2A Jueves])
materiasModulos[2A Viernes 1] = MateriaHorario(id=21, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2A Viernes])
materiasModulos[2B Lunes 1] = MateriaHorario(id=22, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2B Lunes])
materiasModulos[2B Martes 1] = MateriaHorario(id=23, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2B Martes])
materiasModulos[2B Miercoles 1] = MateriaHorario(id=24, fechacreacion=datetime.date.today(), materia=materias[CP], modulo=modulos['1'], dia=cronogramasDias[2B Miercoles])
materiasModulos[2B Jueves 1] = MateriaHorario(id=25, fechacreacion=datetime.date.today(), materia=materias[CP], modulo=modulos['1'], dia=cronogramasDias[2B Jueves])
materiasModulos[2B Viernes 1] = MateriaHorario(id=26, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[2B Viernes])
materiasModulos[2C Lunes 1] = MateriaHorario(id=27, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2C Lunes])
materiasModulos[2C Martes 1] = MateriaHorario(id=28, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[2C Martes])
materiasModulos[2C Miercoles 1] = MateriaHorario(id=29, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2C Miercoles])
materiasModulos[2C Jueves 1] = MateriaHorario(id=30, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2C Jueves])
materiasModulos[2C Viernes 1] = MateriaHorario(id=31, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[2C Viernes])
materiasModulos[3A Lunes 1] = MateriaHorario(id=32, fechacreacion=datetime.date.today(), materia=materias[TL], modulo=modulos['1'], dia=cronogramasDias[3A Lunes])
materiasModulos[3A Martes 1] = MateriaHorario(id=33, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3A Martes])
materiasModulos[3A Miercoles 1] = MateriaHorario(id=34, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[3A Miercoles])
materiasModulos[3A Jueves 1] = MateriaHorario(id=35, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3A Jueves])
materiasModulos[3A Viernes 1] = MateriaHorario(id=36, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3A Viernes])
materiasModulos[3B Lunes 1] = MateriaHorario(id=37, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3B Lunes])
materiasModulos[3B Martes 1] = MateriaHorario(id=38, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3B Martes])
materiasModulos[3B Miercoles 1] = MateriaHorario(id=39, fechacreacion=datetime.date.today(), materia=materias[TL], modulo=modulos['1'], dia=cronogramasDias[3B Miercoles])
materiasModulos[3B Jueves 1] = MateriaHorario(id=40, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3B Jueves])
materiasModulos[3B Viernes 1] = MateriaHorario(id=41, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[3B Viernes])
materiasModulos[3C Lunes 1] = MateriaHorario(id=42, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3C Lunes])
materiasModulos[3C Martes 1] = MateriaHorario(id=43, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[3C Martes])
materiasModulos[3C Miercoles 1] = MateriaHorario(id=44, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3C Miercoles])
materiasModulos[3C Jueves 1] = MateriaHorario(id=45, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3C Jueves])
materiasModulos[3C Viernes 1] = MateriaHorario(id=46, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[3C Viernes])
materiasModulos[4A Lunes 1] = MateriaHorario(id=47, fechacreacion=datetime.date.today(), materia=materias[ING], modulo=modulos['1'], dia=cronogramasDias[4A Lunes])
materiasModulos[4A Martes 1] = MateriaHorario(id=48, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4A Martes])
materiasModulos[4A Miercoles 1] = MateriaHorario(id=49, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4A Miercoles])
materiasModulos[4A Jueves 1] = MateriaHorario(id=50, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4A Jueves])
materiasModulos[4A Viernes 1] = MateriaHorario(id=51, fechacreacion=datetime.date.today(), materia=materias[ING], modulo=modulos['1'], dia=cronogramasDias[4A Viernes])
materiasModulos[4B Lunes 1] = MateriaHorario(id=52, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4B Lunes])
materiasModulos[4B Martes 1] = MateriaHorario(id=53, fechacreacion=datetime.date.today(), materia=materias[GEO], modulo=modulos['1'], dia=cronogramasDias[4B Martes])
materiasModulos[4B Miercoles 1] = MateriaHorario(id=54, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4B Miercoles])
materiasModulos[4B Jueves 1] = MateriaHorario(id=55, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4B Jueves])
materiasModulos[4B Viernes 1] = MateriaHorario(id=56, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4B Viernes])
materiasModulos[4C Lunes 1] = MateriaHorario(id=57, fechacreacion=datetime.date.today(), materia=materias[GEO], modulo=modulos['1'], dia=cronogramasDias[4C Lunes])
materiasModulos[4C Martes 1] = MateriaHorario(id=58, fechacreacion=datetime.date.today(), materia=materias[GEO], modulo=modulos['1'], dia=cronogramasDias[4C Martes])
materiasModulos[4C Miercoles 1] = MateriaHorario(id=59, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4C Miercoles])
materiasModulos[4C Jueves 1] = MateriaHorario(id=60, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4C Jueves])
materiasModulos[4C Viernes 1] = MateriaHorario(id=61, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[4C Viernes])
materiasModulos[5A Lunes 1] = MateriaHorario(id=62, fechacreacion=datetime.date.today(), materia=materias[GEO], modulo=modulos['1'], dia=cronogramasDias[5A Lunes])
materiasModulos[5A Martes 1] = MateriaHorario(id=63, fechacreacion=datetime.date.today(), materia=materias[ING], modulo=modulos['1'], dia=cronogramasDias[5A Martes])
materiasModulos[5A Miercoles 1] = MateriaHorario(id=64, fechacreacion=datetime.date.today(), materia=materias[SEAM], modulo=modulos['1'], dia=cronogramasDias[5A Miercoles])
materiasModulos[5A Jueves 1] = MateriaHorario(id=65, fechacreacion=datetime.date.today(), materia=materias[PSIC], modulo=modulos['1'], dia=cronogramasDias[5A Jueves])
materiasModulos[5A Viernes 1] = MateriaHorario(id=66, fechacreacion=datetime.date.today(), materia=materias[LEN], modulo=modulos['1'], dia=cronogramasDias[5A Viernes])
materiasModulos[5B Lunes 1] = MateriaHorario(id=67, fechacreacion=datetime.date.today(), materia=materias[FCR], modulo=modulos['1'], dia=cronogramasDias[5B Lunes])
materiasModulos[5B Martes 1] = MateriaHorario(id=68, fechacreacion=datetime.date.today(), materia=materias[IE], modulo=modulos['1'], dia=cronogramasDias[5B Martes])
materiasModulos[5B Miercoles 1] = MateriaHorario(id=69, fechacreacion=datetime.date.today(), materia=materias[DT], modulo=modulos['1'], dia=cronogramasDias[5B Miercoles])
materiasModulos[5B Jueves 1] = MateriaHorario(id=70, fechacreacion=datetime.date.today(), materia=materias[EA], modulo=modulos['1'], dia=cronogramasDias[5B Jueves])
materiasModulos[5B Viernes 1] = MateriaHorario(id=71, fechacreacion=datetime.date.today(), materia=materias[ING], modulo=modulos['1'], dia=cronogramasDias[5B Viernes])
materiasModulos[5C Lunes 1] = MateriaHorario(id=72, fechacreacion=datetime.date.today(), materia=materias[QUI], modulo=modulos['1'], dia=cronogramasDias[5C Lunes])
materiasModulos[5C Martes 1] = MateriaHorario(id=73, fechacreacion=datetime.date.today(), materia=materias[PRG], modulo=modulos['1'], dia=cronogramasDias[5C Martes])
materiasModulos[5C Miercoles 1] = MateriaHorario(id=74, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[5C Miercoles])
materiasModulos[5C Jueves 1] = MateriaHorario(id=75, fechacreacion=datetime.date.today(), materia=materias[SIST], modulo=modulos['1'], dia=cronogramasDias[5C Jueves])
materiasModulos[5C Viernes 1] = MateriaHorario(id=76, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[5C Viernes])
materiasModulos[6A Lunes 1] = MateriaHorario(id=77, fechacreacion=datetime.date.today(), materia=materias[], modulo=modulos['1'], dia=cronogramasDias[6A Lunes])
materiasModulos[6A Martes 1] = MateriaHorario(id=78, fechacreacion=datetime.date.today(), materia=materias[], modulo=modulos['1'], dia=cronogramasDias[6A Martes])
materiasModulos[6A Miercoles 1] = MateriaHorario(id=79, fechacreacion=datetime.date.today(), materia=materias[], modulo=modulos['1'], dia=cronogramasDias[6A Miercoles])
materiasModulos[6A Jueves 1] = MateriaHorario(id=80, fechacreacion=datetime.date.today(), materia=materias[], modulo=modulos['1'], dia=cronogramasDias[6A Jueves])
materiasModulos[6A Viernes 1] = MateriaHorario(id=81, fechacreacion=datetime.date.today(), materia=materias[], modulo=modulos['1'], dia=cronogramasDias[6A Viernes])
materiasModulos[6B Lunes 1] = MateriaHorario(id=82, fechacreacion=datetime.date.today(), materia=materias[MIE], modulo=modulos['1'], dia=cronogramasDias[6B Lunes])
materiasModulos[6B Martes 1] = MateriaHorario(id=83, fechacreacion=datetime.date.today(), materia=materias[FCR], modulo=modulos['1'], dia=cronogramasDias[6B Martes])
materiasModulos[6B Miercoles 1] = MateriaHorario(id=84, fechacreacion=datetime.date.today(), materia=materias[MAT], modulo=modulos['1'], dia=cronogramasDias[6B Miercoles])
materiasModulos[6B Jueves 1] = MateriaHorario(id=85, fechacreacion=datetime.date.today(), materia=materias[ESTA], modulo=modulos['1'], dia=cronogramasDias[6B Jueves])
materiasModulos[6B Viernes 1] = MateriaHorario(id=86, fechacreacion=datetime.date.today(), materia=materias[INSE], modulo=modulos['1'], dia=cronogramasDias[6B Viernes])
materiasModulos[6C Lunes 1] = MateriaHorario(id=87, fechacreacion=datetime.date.today(), materia=materias[ST], modulo=modulos['1'], dia=cronogramasDias[6C Lunes])
materiasModulos[6C Martes 1] = MateriaHorario(id=88, fechacreacion=datetime.date.today(), materia=materias[EA], modulo=modulos['1'], dia=cronogramasDias[6C Martes])
materiasModulos[6C Miercoles 1] = MateriaHorario(id=89, fechacreacion=datetime.date.today(), materia=materias[ING], modulo=modulos['1'], dia=cronogramasDias[6C Miercoles])
materiasModulos[6C Jueves 1] = MateriaHorario(id=90, fechacreacion=datetime.date.today(), materia=materias[BASE], modulo=modulos['1'], dia=cronogramasDias[6C Jueves])
materiasModulos[6C Viernes 1] = MateriaHorario(id=91, fechacreacion=datetime.date.today(), materia=materias[PRG], modulo=modulos['1'], dia=cronogramasDias[6C Viernes])
materiasModulos[7A Lunes 1] = MateriaHorario(id=92, fechacreacion=datetime.date.today(), materia=materias[GEO], modulo=modulos['1'], dia=cronogramasDias[7A Lunes])
materiasModulos[7A Martes 1] = MateriaHorario(id=93, fechacreacion=datetime.date.today(), materia=materias[ING], modulo=modulos['1'], dia=cronogramasDias[7A Martes])
materiasModulos[7A Miercoles 1] = MateriaHorario(id=94, fechacreacion=datetime.date.today(), materia=materias[SEAM], modulo=modulos['1'], dia=cronogramasDias[7A Miercoles])
materiasModulos[7A Jueves 1] = MateriaHorario(id=95, fechacreacion=datetime.date.today(), materia=materias[PSIC], modulo=modulos['1'], dia=cronogramasDias[7A Jueves])
materiasModulos[7A Viernes 1] = MateriaHorario(id=96, fechacreacion=datetime.date.today(), materia=materias[LEN], modulo=modulos['1'], dia=cronogramasDias[7A Viernes])
materiasModulos[7B Lunes 1] = MateriaHorario(id=97, fechacreacion=datetime.date.today(), materia=materias[TL], modulo=modulos['1'], dia=cronogramasDias[7B Lunes])
materiasModulos[7B Martes 1] = MateriaHorario(id=98, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[7B Martes])
materiasModulos[7B Miercoles 1] = MateriaHorario(id=99, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[7B Miercoles])
materiasModulos[7B Jueves 1] = MateriaHorario(id=100, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[7B Jueves])
materiasModulos[7B Viernes 1] = MateriaHorario(id=101, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[7B Viernes])
materiasModulos[7C Lunes 1] = MateriaHorario(id=102, fechacreacion=datetime.date.today(), materia=materias[PSIC], modulo=modulos['1'], dia=cronogramasDias[7C Lunes])
materiasModulos[7C Martes 1] = MateriaHorario(id=103, fechacreacion=datetime.date.today(), materia=materias[LEN], modulo=modulos['1'], dia=cronogramasDias[7C Martes])
materiasModulos[7C Miercoles 1] = MateriaHorario(id=104, fechacreacion=datetime.date.today(), materia=materias[TL], modulo=modulos['1'], dia=cronogramasDias[7C Miercoles])
materiasModulos[7C Jueves 1] = MateriaHorario(id=105, fechacreacion=datetime.date.today(), materia=materias[FIS], modulo=modulos['1'], dia=cronogramasDias[7C Jueves])
materiasModulos[7C Viernes 1] = MateriaHorario(id=106, fechacreacion=datetime.date.today(), materia=materias[BIO], modulo=modulos['1'], dia=cronogramasDias[7C Viernes])
(venv) prog@prog-To-be-filled-by-O-E-M:~/Escritorio/integrador$ 
        materiasModulos[] = MateriaHorario(id=1, fechacreacion=datetime.date.today(), materia=materias[], modulo=modulos[], dia=cronogramasDias[])
